...
const loginUser = asyncHandler(async (req, res) => {
    ...
    const cookie = res.cookie("accessToken", accessToken, options)
    console.log(cookie)
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    ).select(" -password");  //we do not want to send the password back in response so we use select function of mongoose and pass )
